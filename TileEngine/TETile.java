...
public class TETile {
    ...
    public static TETile fadeTile(TETile tile, int distance, double lightFactor) {
        double factor = 1 / (distance * lightFactor + 1.0);
        Color newTextColor = new Color((int) (tile.textColor.getRed() * factor),
                (int) (tile.textColor.getGreen() * factor), (int) (tile.textColor.getBlue() * factor));
        Color newBackgroundColor = new Color((int) (tile.backgroundColor.getRed() * factor),
                (int) (tile.backgroundColor.getGreen() * factor), (int) (tile.backgroundColor.getBlue() * factor));
        return new TETile(tile.character, newTextColor, newBackgroundColor, tile.description);
    }

    public static TETile getBackgroundColor(Entity e, TETile covered) {
        TETile curr = e.getIcon();
        return new TETile(curr.character, curr.textColor, covered.backgroundColor, curr.description);
    }
    ...
    public static boolean checkIsClosedDoor(TETile t) {
        return t.description().equals(Tileset.LOCKED_DOOR.description())
                || t.description().equals(Tileset.CLOSED_DOOR.description());
    }
